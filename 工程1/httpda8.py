...
class ServerHTTP(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        buf = '''<!DOCTYPE HTML>
                <html>
                <head><font size="7"><title>Get page</title><meta http-equiv="Content-Type" content="text/html; charset=utf-8"></head>
                <body>
                
                <form action="post_page" method="post">
                  输入预约凭证: <input type="number" name="凭证" style="width:300px;font-size:45px;max="12"/><br />
                  <input type="submit" value="提交"style="height:60px;font-size:40px;"  />
                </form>
    ...
    def do_POST(self):
        ...
        buf = '''<!DOCTYPE HTML>
        <html>
            <head><font size="7"><title>Post page</title><meta http-equiv="Content-Type" content="text/html; charset=utf-8"></head>
            <body>  %s  <br />   %s </body>
        </html>'''%(datas,datas2)
        self.wfile.write(buf)
