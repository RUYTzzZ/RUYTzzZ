...
my_txt='学号'+str(xh)+'座位号'+str(zwh)+'如果你可以足够幸运看到这个邮件，那么说明服务已经启动\r\n 但是在此之前你需要保证的是此学号没有进入预约'
...
def jiancha():
  ...
  while 1:
    ...
    if '成功' in reply1_1:
           printcn("预约成功 ")
           my_txt='学号'+str(xh)+'如果你幸运的看到了这封邮件\r\n那么希望已经预约成功了，你可以观察预约一下预约时间是否为你所预期的，在此刻之后 ，系统将会尝试继续锁定十分钟，十分钟内你可以通过取消预约来重置预约状态'
           mail(my_txt)
